...
public class CollaboRvAdapter extends RecyclerView.Adapter<CollaboRvAdapter.CustomCollaboViewHolder>{
    ...
    public void onBindViewHolder(@NonNull CollaboRvAdapter.CustomCollaboViewHolder holder, int position) {
        ...
        Glide.with(holder.itemView).load(Uri.parse(collabo.getFrontStoreThumbnail())).error(R.drawable.kindcoffee).fallback(R.drawable.hongik).into(holder.front_store_image);
        ...
        Glide.with(holder.itemView).load(Uri.parse(collabo.getBackStoreThumbnail())).error(R.drawable.kindcoffee).fallback(R.drawable.hongik).into(holder.back_store_image);
